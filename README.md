...
This assignment is designed to evaluate my understanding of database table design, ERD relationships, and intermediate-to-advanced SQL queries. I will work with a simplified **Football Ticket Booking System** database.
...
My database design must handle these real-world scenarios by implementing the following exact table fields:
...
I must include the following tables:
...
| 10 | Imran Khan | imran.khan@mail.com | Football Fan | +8801788888888 |
...
| 106 | Manchester United vs Arsenal | Premier League | 110 | Available |
| 107 | Liverpool vs Chelsea | Premier League | 140 | Selling Fast |
| 108 | Paris Saint-Germain vs Lyon | Ligue 1 | 100 | Available |
| 109 | Borussia Dortmund vs Bayern Munich | Bundesliga | 125 | Sold Out |
| 110 | Atletico Madrid vs Real Sociedad | La Liga | 95 | Available |
...
| 506 | 4 | 103 | D-05 | Confirmed | 130 |
| 507 | 5 | 105 | E-10 | Pending | 80 |
| 508 | 6 | 107 | F-08 | Confirmed | 140 |
| 509 | 7 | 108 | *NULL* | *NULL* | 100 |
| 510 | 8 | 110 | G-15 | Cancelled | 95 |

## Part 2: SQL Queries & Output (Open the [QUERY.sql](./QUERY.sql) file and start your queries from there)
...
| 506 | Jannat Ara | Bayern Munich vs PSG | 130 |
| 507 | Fatima Khan | Juventus vs Roma | 80 |
| 508 | Karim Ahmed | Liverpool vs Chelsea | 140 |
| 509 | Nadia Islam | Paris Saint-Germain vs Lyon | 100 |
| 510 | Rashed Hossain | Atletico Madrid vs Real Sociedad | 95 |
...
| 6 | Karim Ahmed | 508 |
| 7 | Nadia Islam | 509 |
| 8 | Rashed Hossain | 510 |
| 9 | Sumaiya Begum | *NULL* |
| 10 | Imran Khan | *NULL* |
...
*(Average total_cost across all 10 bookings = 123.5)*
